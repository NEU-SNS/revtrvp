 ...
 * scamper_firewall.c
 *
 * $Id: scamper_firewall.c,v 1.45 2015/04/27 15:15:01 mjl Exp $
 *
 ...
 */
static int freeslots_cmp(const scamper_firewall_entry_t *a,
			 const scamper_firewall_entry_t *b)
{
...
static int ipfw_init(void)
{
  ...
  if((freeslots = heap_alloc((heap_cmp_t)freeslots_cmp)) == NULL)
    {
